...
/**
 * Unescape custom tooltip text escapes from markdown syntax
 */
    ...
    return `
      <div class="code-block-wrapper">
        <div class="code-block-header">
          ...
          <button class="copy-button" onclick="copyCode('${codeId}', this)">Copy</button>
        </div>
...
<body class="theme-${initialThemePreset}">
      ...
      <div class="container">
        <div class="header-nav">
          ...
          <div class="header-actions">
            <select id="theme-preset" class="theme-select" title="Theme preset" aria-label="Theme preset">
            ...
            <button id="density-toggle" class="density-toggle" title="Toggle reading density">Compact</button>
  ...
  <script>
    ...
    function getCalloutType(rawText) {
      ...
      const bracketMatch = text.match(/^\[!(note|info|tip|important|warning|caution|danger|api|example|decision|gotcha)\]\s*/i);
      if (bracketMatch) return bracketMatch[1].toLowerCase();
      const plainMatch = text.match(/^(note|info|tip|important|warning|caution|danger|api|example|decision|gotcha)\s*:\s*/i);
    ...
    async function copyCode(id, buttonEl) {
      ...
      const btn = buttonEl;
      const original = btn ? btn.innerText : 'Copy';
