...
const html = (
  ...
  const themePresets = ['notebook', 'ops', 'blueprint'];
...
<body class="theme-${initialThemePreset}">
  ...
  <script>
    ...
    function sanitizeThemePreset(theme) {
      return ['notebook', 'ops', 'blueprint'].includes(theme) ? theme : 'notebook';
    }
    ...
    function applyThemePreset(theme) {
      ...
      document.body.classList.remove('theme-notebook', 'theme-ops', 'theme-blueprint');
