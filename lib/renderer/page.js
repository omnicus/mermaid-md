...
<body class="theme-${initialThemePreset}">
        ...
        <div class="header-nav">
          ...
          <div class="header-context">
            ...
            <div class="header-actions">
              ...
              <button id="theme-mode-toggle" class="page-action-button page-action-compact page-action-soft theme-mode-button" onclick="toggleThemeMode()" title="Theme" aria-label="Theme">
  ...
  <script>
    ...
    function syncThemeModeToggle(mode) {
      ...
      const nextMode = safeMode === 'system' ? 'light' : safeMode === 'light' ? 'dark' : 'system';
      const label = safeMode === 'system'
        ? 'Theme: System (' + resolvedMode + '). Click to switch to Light.'
        : 'Theme: ' + safeMode.charAt(0).toUpperCase() + safeMode.slice(1) + '. Click to switch to ' + nextMode.charAt(0).toUpperCase() + nextMode.slice(1) + '.';
    ...
    function getMermaidThemeConfig(theme) {
      ...
      const darkByPreset = {
        ...
        ops: {
          ...
          secondaryColor: '#0e1a29',
          secondaryTextColor: '#c8d8eb',
          tertiaryColor: '#0c141d',
          lineColor: '#7dd3fc',
          clusterBkg: '#0f1c2a',
          clusterBorder: '#38bdf8',
          edgeLabelBackground: '#102030',
          mainBkg: '#11100f',
          darkMode: true,
          fontSize: '14px',
        },
        blueprint: {
          primaryColor: '#102522',
          primaryTextColor: '#e7f4f1',
          primaryBorderColor: '#5eead4',
          secondaryColor: '#0d1e1c',
          secondaryTextColor: '#c6ece6',
          tertiaryColor: '#0b1615',
          lineColor: '#5eead4',
          clusterBkg: '#0d1d1b',
          clusterBorder: '#2dd4bf',
          edgeLabelBackground: '#10211f',
          mainBkg: '#11100f',
          darkMode: true,
          fontSize: '14px',
        },
        editorial: {
          primaryColor: '#2a2018',
          primaryTextColor: '#f2e9de',
          primaryBorderColor: '#d2b48c',
          secondaryColor: '#211912',
          secondaryTextColor: '#e4d5c4',
          tertiaryColor: '#17120e',
          lineColor: '#d2b48c',
          clusterBkg: '#1b1510',
          clusterBorder: '#b08968',
          edgeLabelBackground: '#241c15',
          mainBkg: '#11100f',
          darkMode: true,
          fontSize: '14px',
        },
    ...
    function toggleThemeMode() {
      const currentMode = sanitizeThemeMode(document.documentElement.dataset.themeMode || SERVER_THEME_MODE);
    ...
    generateTOC();
    bindDocsNavigation();
    setThemeMode(SERVER_THEME_MODE);
