module.exports = `
    ...
    .docs-nav-level .docs-nav-level .docs-nav-branch-item > .docs-nav-branch > .docs-nav-row {
      min-height: 32px;
      margin: 2px 16px;
      border-radius: 6px;
    }

    .docs-nav-level .docs-nav-level .docs-nav-section-link {
      padding: 6px 10px 6px min(calc(10px + (var(--nav-level, 0) * 14px)), 66px);
      color: #525252;
      font-weight: 500;
    }

    .docs-nav-level .docs-nav-level .docs-nav-row:hover,
    .docs-nav-level .docs-nav-level .docs-nav-row:focus-within {
      background: #f2f2f2;
    }
    ...
    :root[data-theme-mode='dark'] .docs-nav-row:hover,
    :root[data-theme-mode='dark'] .docs-nav-row:focus-within,
    :root[data-theme-mode='system'][data-resolved-theme-mode='dark'] .docs-nav-row:hover,
    :root[data-theme-mode='system'][data-resolved-theme-mode='dark'] .docs-nav-row:focus-within {
      background: #171717;
    }

    :root[data-theme-mode='dark'] .docs-nav-filter-input,
    :root[data-theme-mode='system'][data-resolved-theme-mode='dark'] .docs-nav-filter-input {
      border-color: #2b2b2b;
      background: #111111;
      color: #fafafa;
    }

    :root[data-theme-mode='dark'] .docs-nav-show-all,
    :root[data-theme-mode='system'][data-resolved-theme-mode='dark'] .docs-nav-show-all {
      background: #171717;
      color: #a3a3a3;
    }

    :root[data-theme-mode='dark'] .docs-nav-show-all:hover,
    :root[data-theme-mode='system'][data-resolved-theme-mode='dark'] .docs-nav-show-all:hover {
      background: #1c1c1c;
      color: #fafafa;
    }
    ...
    :root[data-theme-mode='dark'] .docs-nav-row:has(.docs-nav-section-link.is-active),
    :root[data-theme-mode='system'][data-resolved-theme-mode='dark'] .docs-nav-row:has(.docs-nav-section-link.is-active) {
      background: #1c1c1c;
    }

    :root[data-theme-mode='dark'] .docs-nav-section-link.is-active,
    :root[data-theme-mode='system'][data-resolved-theme-mode='dark'] .docs-nav-section-link.is-active {
      background: transparent;
      color: var(--text-main);
    ...
    :root[data-theme-mode='dark'] .docs-nav-leaf-row:hover .docs-nav-leaf,
    :root[data-theme-mode='dark'] .docs-nav-leaf-item:focus-within .docs-nav-leaf,
    :root[data-theme-mode='system'][data-resolved-theme-mode='dark'] .docs-nav-leaf-row:hover .docs-nav-leaf,
    :root[data-theme-mode='system'][data-resolved-theme-mode='dark'] .docs-nav-leaf-item:focus-within .docs-nav-leaf {
      background: transparent;
      color: var(--text-main);
    }

    :root[data-theme-mode='dark'] .content-body :not(pre) > code,
    :root[data-theme-mode='dark'] .editor-preview :not(pre) > code,
    :root[data-theme-mode='system'][data-resolved-theme-mode='dark'] .content-body :not(pre) > code,
    :root[data-theme-mode='system'][data-resolved-theme-mode='dark'] .editor-preview :not(pre) > code {
      background: var(--inline-code-bg);
      color: var(--inline-code-color);
      border-radius: 3px;
    }

    :root[data-theme-mode='dark'] .terminal-demo,
    :root[data-theme-mode='dark'] .terminal-demo pre,
    :root[data-theme-mode='dark'] .terminal-demo code,
    :root[data-theme-mode='system'][data-resolved-theme-mode='dark'] .terminal-demo,
    :root[data-theme-mode='system'][data-resolved-theme-mode='dark'] .terminal-demo pre,
    :root[data-theme-mode='system'][data-resolved-theme-mode='dark'] .terminal-demo code {
      background: #0a0a0a;
      border-color: #2b2b2b;
      color: var(--text-main);
    }

    :root[data-theme-mode='dark'] .terminal-demo-header,
    :root[data-theme-mode='system'][data-resolved-theme-mode='dark'] .terminal-demo-header {
      background: #171717;
      color: #b8b8b8;
    }
    ...
    :root[data-theme-mode='dark'] .mermaid,
    :root[data-theme-mode='system'][data-resolved-theme-mode='dark'] .mermaid {
      background: #0a0a0a;
      border-color: #2b2b2b;
    }

    :root[data-theme-mode='dark'] svg[id^="mermaid"] .edgeLabel .label text,
    :root[data-theme-mode='dark'] svg[id^="mermaid"] .edgeLabel .label tspan,
    :root[data-theme-mode='system'][data-resolved-theme-mode='dark'] svg[id^="mermaid"] .edgeLabel .label text,
    :root[data-theme-mode='system'][data-resolved-theme-mode='dark'] svg[id^="mermaid"] .edgeLabel .label tspan {
      fill: var(--text-main) !important;
    }

    :root[data-theme-mode='dark'] svg[id^="mermaid"] .edgeLabel .label rect.background,
    :root[data-theme-mode='system'][data-resolved-theme-mode='dark'] svg[id^="mermaid"] .edgeLabel .label rect.background {
